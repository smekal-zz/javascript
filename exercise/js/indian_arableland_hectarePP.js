(function() {
  ...
  function dataViz(inputData) {
    ...
    var inputData = inputData["Arable land (hectares per person)"];
    ...
    var tip = d3.tip()
        ...
        .offset([-10, 0])
        .html(function(d) {
          return "<strong>Land Area (hectares per person):</strong> <span style='color:red'>" + d.landArea + "</span>";
        });
    ...
    svg.append("g")
      ...
      .append("text")
        ...
        .text("Land Area (hectares per person)");
